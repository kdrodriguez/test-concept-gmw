      ...
      <ReflexContainer orientation="horizontal" windowResizeAware  maxSize={100}>
        <ReflexElement minSize={36}>
          ...
          <div className="pane-content">
            <label>  
              <ModalResourceNew buttonLabel="Nueva carpeta" modalTitle="Nueva Carpeta" iconSource="fas fa-folder"/> 
            </label>  
            <label> 
              <Folders/>
            </label> 
        ...
        <ReflexElement minSize={36}>
          ...
          <div className="pane-content">
            <label>
              <ModalResourceNew buttonLabel="Nuevo grupo " modalTitle="Nuevo Grupo" iconSource="fas fa-users"/> 
            </label> 
            <label>
              <Groups/>
            </label> 
